...
//                    Log.e("faceAuth","${detectInImage(InputImage.fromMediaImage(image.image!!, image.imageInfo.rotationDegrees))}")
                    Log.e("faceAuth","${getFaceResults(faces.first())}")
                } else {
                    result(FaceResult())
                    Log.e("faceAuth","${result(FaceResult())}")
                }
            }
